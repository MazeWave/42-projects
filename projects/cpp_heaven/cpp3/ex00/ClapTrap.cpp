...
/*   Updated: 2024/02/26 20:23:57 by ldalmass         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << MAGENTA << "Constructor " << name << RESET << std::endl;
	this->_name = name;
	this->_hit_point = 10;
	this->_energy_point= 10;
	this->_attack_damage = 0;
...
{
	std::cout << MAGENTA << "Destructor " << this->_name << RESET << std::endl;
	return;
}

ClapTrap::ClapTrap(const ClapTrap& input)
{
	std::cout << MAGENTA << "Copy constructor " << input._name << RESET << std::endl;
	*this = input;
	return;
}
...
void	ClapTrap::printStats(void)
{
	...
	std::cout << RESET << "----- " << this->_name << " -----" << RESET << std::endl;
